      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple">Javascript,Nodejs,Html,CSS,React js,Python. </b>
              </i>
              <br />
              <br />
              ...
              &nbsp; like
              <i>
                <b className="purple"> React.js and Exppress js</b>
              </i>
            </p>
          </Col>
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <p>
              Feel free to{" "}
              <Link to="/MyPortfolio/contact_me" className="purple">
                connect{" "}
              </Link>
              with me
            </p>
